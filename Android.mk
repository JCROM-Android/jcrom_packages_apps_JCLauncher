...
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := jclauncher_protoutil_lib
...
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := jclauncher_protoutil

include $(BUILD_SYSTEM)/base_rules.mk

$(LOCAL_BUILT_MODULE): jclauncher_protoutil_lib
$(LOCAL_BUILT_MODULE): $(LOCAL_PATH)/util/etc/jclauncher_protoutil | $(ACP)
