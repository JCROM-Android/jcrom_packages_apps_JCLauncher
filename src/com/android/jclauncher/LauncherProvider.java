...
import com.android.jclauncher.AutoInstallsLayout.LayoutParserCallback;
...
import com.android.jclauncher.config.ProviderConfig;
...
public class LauncherProvider extends ContentProvider {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper implements LayoutParserCallback {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            // - Passion shipped on 2.1 with version 6 of jclauncher
    ...
    private static String getAttributeValue(XmlResourceParser parser, String attribute) {
        String value = parser.getAttributeValue(
                "http://schemas.android.com/apk/res-auto/com.android.jclauncher", attribute);
        if (value == null) {
